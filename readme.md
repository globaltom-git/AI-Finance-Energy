...
|---------|-------------|------------------|--------------------|--------|
| Wind Power Production Forecasting – France | Machine learning model forecasting national onshore wind power production in France using ENTSO-E data and multi-zone meteorological features, with robust UTC time handling and hourly predictions.| Python, Pandas, ENTSO-E API, Open-Meteo, Feature Engineering, LightGBM, XGBoost | Time-Series Modeling Improves day-ahead wind generation forecasts for energy planning, grid operations, and power market analysis by reducing prediction error by more than 85% compared to a climatological baseline.| Completed – validated on 2015–2025 historical data -|
